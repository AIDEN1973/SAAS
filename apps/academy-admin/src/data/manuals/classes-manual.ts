...
export const classesManual: ManualPage = {
  id: 'classes',
  title: '수업관리',
  description: '학원의 수업을 등록하고 관리하는 페이지입니다.',
  icon: 'BookOpen',
  ...
  sections: [
    {
      ...
      type: 'intro',
      intro:
        '학원의 **수업을 관리**하는 핵심적인 화면입니다. 좌측 메뉴에서 **"더보기" → "수업관리"**를 클릭하여 접근합니다. 새로운 수업을 만들거나, 기존 수업의 정보를 수정하고, 수업 시간과 요일을 설정할 수 있습니다. **리스트 보기**와 **캘린더(편성표) 보기** 두 가지 모드를 지원하여 원하는 방식으로 수업 정보를 확인할 수 있습니다. 기본적으로 **오늘 수업만** 표시되어 효율적으로 관리할 수 있습니다.',
    },
    {
      id: 'features',
      title: '주요 기능',
      type: 'features',
      features: [
        '수업 생성 : 새로운 수업을 등록하고 기본 정보 설정',
        '수업 수정 : 기존 수업의 이름, 시간, 요일 등 정보 변경',
        '수업 삭제 : 더 이상 운영하지 않는 수업 삭제',
        '수업 검색 : 수업 이름으로 빠르게 검색',
        '요일 필터링 : 특정 요일에 있는 수업만 골라서 보기',
        '상태 필터링 : 활성/비활성 상태로 수업 필터링',
        '리스트 보기 : 수업 목록을 카드 형태로 확인',
        '캘린더 보기 : 요일별/시간별 수업 편성표로 확인',
        '오늘 수업만 보기 : 오늘 있는 수업만 표시 (기본값)',
        '전체 수업 보기 : 모든 수업을 한 번에 확인',
        '일정 충돌 감지 : 같은 시간대에 겹치는 수업 자동 확인',
        '담당 강사 배정 : 수업별로 담당 강사 지정',
        '정원 관리 : 수업별 최대 수강 인원 설정',
      ],
    },
    {
      id: 'steps',
      ...
      stepGuides: [
        {
          title: '새로운 수업 만들기',
          steps: [
            { step: 1, content: '화면 상단 오른쪽의 "수업 생성" 버튼을 클릭합니다.' },
            { step: 2, content: '수업 이름을 입력합니다. 예: "초등 수학 A반", "중등 영어 기초반"' },
            ...
            { step: 10, content: '수업 색상을 선택합니다. 캘린더에서 구분하기 쉽도록 원하는 색상을 지정합니다.' },
            { step: 11, content: '필요한 경우 메모를 입력합니다.' },
            { step: 12, content: '"저장" 또는 "생성" 버튼을 클릭하여 수업을 등록합니다.' },
          ],
          alert: {
            type: 'info',
        ...
        },
        {
          title: '수업 정보 수정하기',
          steps: [
            { step: 1, content: '수정할 수업의 카드에서 "수정" 버튼을 클릭합니다.' },
          ...
          alert: {
            type: 'warning',
            content: '수업 정보를 수정하면 해당 수업에 등록된 학생들에게도 영향이 있을 수 있습니다. 수업 시간 변경 시 학생/학부모에게 미리 안내해주세요.',
          },
        },
        {
          title: '수업 삭제하기',
          steps: [
            { step: 1, content: '삭제할 수업의 카드에서 "삭제" 버튼을 클릭합니다.' },
            { step: 2, content: '삭제 확인 메시지가 나타납니다.' },
            { step: 3, content: '"확인" 버튼을 클릭하면 수업이 삭제됩니다.' },
          ],
          alert: {
            type: 'warning',
            content: '수업을 삭제하면 해당 수업의 출결 기록 등 관련 데이터에 영향을 줄 수 있습니다. 신중하게 결정해주세요.',
          },
        },
        {
          title: '수업 검색하기',
          steps: [
            ...
            { step: 2, content: '찾고자 하는 수업의 이름을 입력합니다.' },
            { step: 3, content: '입력과 동시에 검색 결과가 자동으로 필터링됩니다.' },
            { step: 4, content: '검색어를 지우면 다시 전체 수업 목록이 표시됩니다.' },
          ],
          alert: {
            type: 'info',
            content: '검색어가 입력되면 오늘 수업 필터가 해제되어 모든 수업에서 검색됩니다.',
          },
        },
        {
          ...
          steps: [
            ...
            { step: 5, content: '하단의 범례에서 각 수업의 색상을 확인할 수 있습니다.' },
          ],
        },
        {
          title: '담당 강사 배정하기',
          steps: [
            { step: 1, content: '수업을 생성하거나 수정할 때 "담당 강사" 항목을 찾습니다.' },
            { step: 2, content: '드롭다운에서 배정할 강사를 선택합니다.' },
            { step: 3, content: '여러 명의 강사를 선택할 수 있습니다. (팀 티칭 등)' },
            { step: 4, content: '저장하면 해당 강사가 수업에 배정됩니다.' },
          ],
          alert: {
            type: 'info',
      ...
      screenGroups: [
        {
          title: '상단 액션 버튼 영역',
          items: [
            { title: '오늘 수업만 / 전체 수업 보기', description: '토글 버튼입니다. 오늘 있는 수업만 볼지, 모든 수업을 볼지 선택합니다. 기본값은 "오늘 수업만"입니다.' },
            { title: '리스트 버튼', description: '클릭하면 수업 목록을 카드 형태로 표시합니다. 각 수업의 상세 정보를 확인하기 좋습니다.' },
            { title: '캘린더 버튼', description: '클릭하면 요일별/시간별 수업 편성표 형태로 표시합니다. 수업 시간 배치를 한눈에 보기 좋습니다.' },
            { title: '수업 생성 버튼', description: '클릭하면 새로운 수업을 등록하는 폼이 나타납니다.' },
          ],
        },
        {
          title: '검색 및 필터 영역',
          items: [
            { title: '검색창', description: '수업 이름을 입력하면 해당 수업만 화면에 표시됩니다. 실시간으로 검색 결과가 반영됩니다.' },
            { title: '상태 필터', description: '활성(active) 또는 비활성(inactive) 상태의 수업만 필터링할 수 있습니다.' },
            { title: '요일 필터', description: '특정 요일에 있는 수업만 필터링할 수 있습니다.' },
          ],
        },
        {
          title: '수업 카드 (리스트 보기 모드)',
          items: [
            { title: '수업 이름', description: '수업의 이름이 표시됩니다. 왼쪽에 수업 색상이 세로 띠로 표시됩니다.' },
            ...
            { title: '수정 버튼', description: '클릭하면 해당 수업의 정보를 수정할 수 있는 폼이 나타납니다.' },
            { title: '삭제 버튼', description: '클릭하면 해당 수업을 삭제할 수 있습니다. 삭제 전 확인 메시지가 표시됩니다.' },
          ],
        },
        {
          ...
          items: [
            ...
            { title: '수업 블록', description: '각 시간대에 수업이 있으면 수업 색상으로 채워진 블록이 표시됩니다.' },
            { title: '겹침 표시', description: '같은 시간에 여러 수업이 있으면 점선 테두리와 함께 "+N 겹침"으로 표시됩니다.' },
            { title: '범례', description: '화면 하단에 각 수업의 이름과 색상이 표시되어 구분할 수 있습니다.' },
          ],
        },
        {
          title: '수업 생성/수정 폼',
          items: [
            { title: '수업 이름', description: '필수 입력 항목입니다. 수업을 구분할 수 있는 이름을 입력합니다.' },
            ...
            { title: '담당 강사', description: '수업을 담당하는 강사를 선택합니다. 여러 명 선택 가능합니다.' },
            { title: '강의실', description: '수업이 진행되는 강의실이나 교실을 입력합니다.' },
            { title: '수업 색상', description: '캘린더에서 구분하기 위한 색상을 선택합니다.' },
            { title: '상태', description: '활성(active) 또는 비활성(inactive) 상태를 선택합니다.' },
            { title: '메모', description: '수업에 대한 추가 정보나 메모를 입력합니다.' },
          ],
        },
      ],
    },
      ...
      screenGroups: [
        {
          ...
          items: [
            ...
            { title: '삭제 주의', description: '수업을 삭제하면 해당 수업과 관련된 출결 기록 등에 영향을 줄 수 있습니다.' },
            { title: '상태 변경', description: '수업을 비활성(inactive) 상태로 변경하면 출결 관리 등에서 해당 수업이 표시되지 않습니다.' },
          ],
        },
        {
          title: '효율적으로 사용하는 팁',
          items: [
            ...
            { title: '캘린더 뷰 활용', description: '신규 수업을 만들기 전에 캘린더 뷰에서 빈 시간대를 확인하면 일정 충돌을 미리 방지할 수 있습니다.' },
            { title: '요일 필터 활용', description: '특정 요일의 수업만 확인하고 싶을 때 요일 필터를 사용하세요.' },
            { title: '정원 관리', description: '정원률을 확인하여 수강생이 많은 수업은 분반을 고려해보세요.' },
        ...
        },
        {
          title: '문제 해결',
          items: [
            { title: '수업이 보이지 않아요', description: '"오늘 수업만" 모드에서는 오늘 있는 수업만 표시됩니다. "전체 수업 보기" 버튼을 클릭해보세요.' },
      ...
      screenGroups: [
        {
          title: '모바일에서의 차이점',
          items: [
            { title: '드로어 폼', description: '수업 생성/수정 폼이 화면 하단에서 올라오는 드로어 형태로 표시됩니다.' },
            { title: '1열 카드', description: '수업 카드가 한 줄에 하나씩 표시됩니다.' },
        ...
        },
        {
          title: '태블릿에서의 차이점',
          items: [
            { title: '사이드 드로어', description: '수업 생성/수정 폼이 화면 오른쪽에서 슬라이드되어 나타납니다.' },
            { title: '2~3열 카드', description: '화면 크기에 따라 수업 카드가 2~3열로 표시됩니다.' },
