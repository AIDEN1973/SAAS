  ...
  sections: [
    {
      ...
      type: 'intro',
      intro:
        '학원의 **반(수업)을 관리**하는 핵심적인 화면입니다. 좌측 메뉴에서 **"더보기" → "수업관리"**를 클릭하여 접근합니다. 새로운 반을 만들거나, 기존 반의 정보를 수정하고, 수업 시간과 요일을 설정할 수 있습니다. **리스트 보기**와 **캘린더(편성표) 보기** 두 가지 모드를 지원하여 원하는 방식으로 반 정보를 확인할 수 있습니다. 기본적으로 **오늘 수업이 있는 반만** 표시되어 효율적으로 관리할 수 있습니다.',
    },
    {
      id: 'features',
      title: '주요 기능',
