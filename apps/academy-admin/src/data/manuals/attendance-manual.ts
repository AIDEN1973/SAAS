  ...
  sections: [
    {
      ...
      type: 'intro',
      intro:
        '학생의 **출결을 관리**하는 핵심적인 화면입니다. 매일 학원에 오는 학생들의 등원과 하원을 체크하고, 출석/지각/결석 상태를 기록합니다. **오늘 수업이 있는 학생만** 자동으로 표시되어 효율적으로 출결 처리를 할 수 있습니다.',
    },
    {
      id: 'features',
      title: '주요 기능',
      ...
      stepGuides: [
        {
          title: '기본 출결 처리 방법',
          steps: [
            { step: 1, content: '화면 상단의 "수업 선택" 드롭다운에서 원하는 수업을 선택합니다. 오늘 있는 수업만 표시됩니다.' },
      ...
      screenGroups: [
        {
          title: '상단 필터 영역',
          items: [
            { title: '수업 선택 드롭다운', description: '클릭하면 오늘 있는 수업 목록이 표시됩니다. 원하는 수업을 선택하세요.' },
        ...
        },
        {
          ...
          items: [
            ...
            { title: '학년/수업 정보', description: '학생이 속한 학년과 수업 정보가 이름 아래에 표시됩니다.' },
      ...
      screenGroups: [
        {
          ...
          items: [
            ...
            { title: '오늘 수업만 표시', description: '수업 선택 목록에는 오늘 요일에 있는 수업만 표시됩니다. 다른 수업이 보이지 않는다면 정상입니다.' },
          ],
        },
        {
          title: '효율적으로 사용하는 팁',
          items: [
            ...
            { title: '수업 선택 먼저', description: '수업을 먼저 선택하면 해당 수업 학생만 표시되어 한눈에 파악하기 쉽습니다.' },
            ...
            { title: '마지막 수업 기억', description: '마지막으로 선택한 수업이 자동으로 기억되어 다음에 접속해도 같은 수업이 선택되어 있습니다.' },
          ],
        },
        {
          title: '문제 해결',
          items: [
            { title: '학생이 보이지 않아요', description: '수업을 선택했는데 학생이 없다면, 해당 수업에 학생이 등록되어 있는지 확인하세요.' },
            { title: '수업이 보이지 않아요', description: '오늘 있는 수업만 표시됩니다. 수업 설정에서 요일을 확인하세요.' },
    ...
    },
    {
      ...
      technicalFeatures: [
        ...
        'localStorage 상태 유지 (탭, 마지막 선택 수업)',
