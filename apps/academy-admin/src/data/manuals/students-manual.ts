  ...
  sections: [
    {
      ...
      type: 'intro',
      intro:
        '학원에 다니는 **모든 학생의 정보를 관리**하는 핵심적인 화면입니다. 신규 학생을 등록하고, 기존 학생의 정보를 수정하거나 확인할 수 있습니다. 학생별로 **기본정보, 보호자정보, 상담기록, 태그, 수업 배정, 출결기록** 등 다양한 정보를 한 곳에서 통합 관리할 수 있어 효율적인 학원 운영이 가능합니다.',
    },
    {
      id: 'features',
      title: '주요 기능',
      ...
      stepGuides: [
        ...
        },
        {
          ...
          steps: [
            ...
            { step: 3, content: '상단의 탭 버튼을 클릭하여 "학생 기본정보", "보호자 정보", "상담일지", "태그 관리", "수업 배정", "출결 기록", "위험도분석", "메시지 발송" 등 원하는 정보로 이동합니다.' },
        ...
        },
        {
          ...
          steps: [
            ...
            { step: 4, content: '"수업" 드롭다운에서 원하는 수업을 선택합니다.' },
      ...
      screenGroups: [
        ...
        },
        {
          ...
          items: [
            ...
            { title: '수업 필터', description: '"수업" 드롭다운에서 특정 수업에 배정된 학생만 볼 수 있습니다.' },
          ],
        },
        {
          title: '학생 목록 테이블',
        ...
        },
        {
          ...
          items: [
            ...
            { title: '탭 버튼 영역', description: '기본정보, 보호자정보, 상담일지, 태그관리, 수업 배정, 출결기록, 위험도분석, 메시지발송 탭 버튼이 나열됩니다.' },
    ...
    },
    {
      ...
      screenGroups: [
        ...
        },
        {
          title: '수업 배정 탭',
          items: [
            { title: '배정된 수업 목록', description: '학생이 현재 배정된 수업들이 표시됩니다. 수업명, 과목, 대상, 요일, 시간, 강의실, 배정일 정보가 표시됩니다.' },
            { title: '수업 배정 버튼', description: '"+" 아이콘을 클릭하여 학생을 새 수업에 배정할 수 있습니다. 이미 배정된 수업은 목록에서 제외됩니다.' },
            { title: '수업 제외 버튼', description: '휴지통 아이콘을 클릭하면 해당 수업에서 학생을 제외합니다.' },
            { title: '배정일 수정', description: '연필 아이콘을 클릭하면 배정일을 수정하거나 다른 수업으로 이동할 수 있습니다.' },
          ],
        },
        {
          title: '출결기록 탭',
          items: [
            ...
            { title: '출결 기록 추가', description: '"+" 아이콘을 클릭하여 수동으로 출결 기록을 추가할 수 있습니다. 수업, 시간, 유형, 상태, 메모를 입력할 수 있습니다.' },
      ...
      screenGroups: [
        {
          ...
          items: [
            ...
            { title: '권한에 따른 제한', description: 'Teacher나 Assistant 역할인 경우 일부 기능(삭제, 태그관리, 수업 배정 등)이 제한될 수 있습니다.' },
          ],
        },
        {
          title: '효율적으로 사용하는 팁',
          items: [
            ...
            { title: '필터 조합', description: '상태, 학년, 수업, 태그 필터를 조합하면 원하는 학생 그룹을 정확하게 찾을 수 있습니다.' },
