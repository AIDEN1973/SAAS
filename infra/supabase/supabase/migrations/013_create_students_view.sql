...
-- PostgREST가 View를 인식하도록 스키마를 public 스키마에 노출
-- ⚠️ 참고: Supabase Dashboard > Settings > API > "Reload schema" 버튼을 클릭하거나,
-- 또는 Supabase CLI를 사용하여 스키마를 다시 로드해야 할 수 있습니다.
-- CLI 명령: supabase db reset (개발 환경) 또는 supabase migration up (프로덕션)
