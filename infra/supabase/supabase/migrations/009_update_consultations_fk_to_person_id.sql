-- student_consultations 테이블의 student_id FK를 person_id로 변경
-- [불변 규칙] 기존 student_id는 person_id를 참조하도록 변경

-- 1. 기존 FK 제약 조건 삭제
ALTER TABLE IF EXISTS public.student_consultations
  DROP CONSTRAINT IF EXISTS student_consultations_student_id_fkey;
