 ...
 * [불변 규칙] 클라이언트에서는 타입만 import: import type { ... } from '@services/student-service'
 * [불변 규칙] 서버 코드는 서버/Edge에서만 사용: import { studentService } from '@services/student-service/service'
 * 
