 ...
 * Core Notification
 *
 * 메시지 알림 (SMS, 카카오 알림톡, 이메일, Push)
 * [불변 규칙] 클라이언트에서는 타입만 import: import type { ... } from '@core/notification'
 * [불변 규칙] 서버 코드는 서버/Edge에서만 사용: import { notificationService } from '@core/notification/service'
 *
