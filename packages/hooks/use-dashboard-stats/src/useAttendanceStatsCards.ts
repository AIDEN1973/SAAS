...
import { fetchAttendanceStats, fetchAttendanceLogs } from '@hooks/use-attendance';
import type { StatsCard } from '../../../apps/academy-admin/src/types/dashboardCard';
import { calculateTrendPercentPoint } from '../../../apps/academy-admin/src/utils/trend-calculation-utils';
